...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'Steves house', time: "8:00" },
        { title: 'another event', id: 2, description: 'something even cooler', location: 'a cool bar', time: '12:00'}        
    ]
};
